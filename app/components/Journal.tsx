        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="col-span-12 lg:col-span-5 flex flex-col justify-center">
            <Reveal delay={120}>
              ...
              <h2 className="font-serif text-[42px] lg:text-[52px] leading-[1.05] text-ink mb-6">
                On the architecture of{" "}
                <span className="italic font-light">staying put</span>
              </h2>
            </Reveal>
            <Reveal delay={240}>
              <p className="font-serif text-[17px] leading-[1.65] text-ink-soft mb-4">
              ...
              <p className="font-serif text-[17px] leading-[1.65] text-ink-soft mb-8">
